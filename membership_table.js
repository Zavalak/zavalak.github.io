export const initMembershipTable = () => {
  ...
  const tiers = [
    { 
      ...
      price: "$0.00", 
      highlight: false, 
      data: ["$0.00", "$0.00", "$199.99/hr", "---", "$249.99", "$249.99", "---", "---", "---"] 
    },
    { 
      name: "Non-Member", 
      price: "$0.00", 
      highlight: false, 
      data: ["$79.99", "$69.99", "$199.99/hr", "Standard", "$249.99", "$249.99", "$79.99", "Yes", "---"] 
    },
    { 
      name: "Basic Member", 
      // Added line-through on original price and shown discounted price
      price: `<span class="line-through opacity-40 text-sm sm:text-lg block mb-1">$249.99</span>$199.99`, 
      highlight: false, 
      data: ["Waived*<br/><span class='opacity-60 text-[8px]'>$49.99</span>", "$39.99", "$149.99/hr", "Standard", "INCLUDED", "INCLUDED", "$49.99", "Yes", "---"] 
    },
    { 
      name: "Premium Member", 
      // Added line-through on original price and shown discounted price
      price: `<span class="line-through opacity-40 text-sm sm:text-lg block mb-1">$499.99</span>$399.99`, 
      highlight: true, 
        ...
        <tbody>
          ...
          <tr class="bg-white/5">
            ...
            <td class="p-3 sm:p-6 text-center text-white font-bold text-[10px] sm:text-sm">
               $370.00 <span class="block text-[8px] text-[#B87333] mt-1">+20% PROMO</span>
            </td>
            <td class="p-3 sm:p-6 text-center border-x border-b border-[#B87333] bg-[#B87333]/10 text-[#B87333] font-black tracking-tighter text-[10px] sm:text-sm">
               $190.00+ & VIP <span class="block text-[8px] text-white mt-1">+20% PROMO</span>
            </td>
          </tr>
        </tbody>
      </table>
    ...
    <div class="max-w-3xl mx-auto mt-10 sm:mt-16 space-y-4 px-4 text-center">
      ...
      <div class="border-b border-white/5 pb-6">
        <p class="text-[10px] sm:text-[11px] uppercase tracking-widest font-black text-slate-200 mb-2 underline decoration-[#B87333] underline-offset-4">
          * First On-Site Diagnostic Discount
        </p>
        <p class="text-xs sm:text-sm text-slate-500 leading-relaxed font-medium">
          The 'First On-Site Diagnostic' rate for Basic Members is a localized incentive. New Business enrollees receive an additional 20% off their initial membership dues. All subsequent services follow established tier pricing.
        </p>
      </div>
    </div>
  `;

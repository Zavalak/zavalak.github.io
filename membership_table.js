export const initMembershipTable = () => {
  ...
  const tiers = [
    { name: "One-Time Evaluation", price: "$0.00", highlight: false, data: ["$0.00", "$0.00", "$199.99/hr", "---", "$249.99", "$249.99", "---", "---", "---"] },
    { name: "Non-Member", price: "$0.00", highlight: false, data: ["$79.99", "$69.99", "$199.99/hr", "Standard", "$249.99", "$249.99", "$79.99", "Yes", "---"] },
    { name: "Basic", price: "$249.99", highlight: false, data: ["Waived*<br/><span class='opacity-60 text-[8px]'>$49.99</span>", "$39.99", "$149.99/hr", "Standard", "INCLUDED", "INCLUDED", "$49.99", "Yes", "---"] },
    { name: "Premium", price: "$499.99", highlight: true, data: ["Waived", "Waived", "$99.99/hr", "15% discount", "INCLUDED", "INCLUDED", "Waived", "WAIVED", "Under 24h"] }
  ];
  ...
  const tableHtml = `
    ...
    <div class="max-w-3xl mx-auto mt-10 sm:mt-16 space-y-4 px-4">
      <h3 class="text-[9px] sm:text-[10px] font-black tracking-[0.4em] text-[#B87333] uppercase text-center mb-6 sm:mb-8 italic underline decoration-1 underline-offset-8">Membership Disclosure</h3>
      <div class="border-b border-white/5 pb-6">
        <p class="text-[10px] sm:text-[11px] uppercase tracking-widest font-black text-slate-200 mb-2 underline decoration-[#B87333] underline-offset-4">* First On-Site Diagnostic Waiver</p>
        <p class="text-xs sm:text-sm text-slate-500 leading-relaxed font-medium">
          The 'First On-Site Diagnostic Waived' benefit for the Basic Membership tier is an exclusive incentive for new members during their first year of enrollment. All subsequent diagnostics are performed at the significantly reduced membership rate established for your tier.
        </p>
      </div>
    </div>
  `;
